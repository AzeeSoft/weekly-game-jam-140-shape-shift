...
Shader "Custom/Tomas/EnergyScroll"
{
	Properties
	{
		_TopY("TopY", Float) = 10000
		_BottomY("BottomY", Float) = 0
		_DisintegrationValue("DisintegrationValue", Range( 0 , 1)) = 0
		_DisintegrationMap("Disintegration Map", 2D) = "white" {}
		_DisintegrationMapSize("DisintegrationMapSize", Float) = 0
		_DisintegrationColor("DisintegrationColor", Color) = (0,0,0,0)
		_DisintegrationColorSize("DisintegrationColorSize", Float) = 0
	...
	SubShader
	{
		...
		uniform sampler2D _DisintegrationMap;
		uniform float4 _DisintegrationMap_ST;
		uniform float _DisintegrationMapSize;
		uniform float _TopY;
		uniform float _BottomY;
		uniform float _DisintegrationValue;
		uniform float _DisintegrationColorSize;
		uniform float4 _Color;
		uniform sampler2D _Albedo;
		uniform float4 _Albedo_ST;
		uniform float4 _DisintegrationColor;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Normal = Normal282;
			float2 uv_DisintegrationMap = i.uv_texcoord * _DisintegrationMap_ST.xy + _DisintegrationMap_ST.zw;
			float3 ase_worldPos = i.worldPos;
			float ClipValue19_g1 = ( ( length( tex2D( _DisintegrationMap, uv_DisintegrationMap ) ) / _DisintegrationMapSize ) + ( ( ( ( _TopY - _BottomY ) * ( 1.0 - _DisintegrationValue ) ) + _BottomY ) - ase_worldPos.y ) );
			float2 uv_Albedo = i.uv_texcoord * _Albedo_ST.xy + _Albedo_ST.zw;
			float4 Albedo279 = ( _Color * tex2D( _Albedo, uv_Albedo ) );
			float4 originalAlbedo31_g1 = Albedo279;
			float4 FinalAlbedo23_g1 =  ( ClipValue19_g1 - 0.0 > _DisintegrationColorSize ? originalAlbedo31_g1 : ClipValue19_g1 - 0.0 <= _DisintegrationColorSize && ClipValue19_g1 + 0.0 >= _DisintegrationColorSize ? originalAlbedo31_g1 : ( ( _DisintegrationColor + originalAlbedo31_g1 ) * ClipValue19_g1 ) ) ;
			clip( ClipValue19_g1 - 0.1);
			o.Albedo = FinalAlbedo23_g1.rgb;
			...
			float4 Mask296 = tex2D( _Mask, uv_Mask );
			float4 ShieldPattern17 = tex2D( _ShieldPattern, ( float4( uv_TexCoord41, 0.0 , 0.0 ) + Mask296 ).rg );
			...
			float4 lerpResult124 = lerp( _IntersectColor , ( ( ShieldPattern17 * waves94 ) * ( hit170 * ShieldPatternColor12 ) ) , clampResult113);
			float ShieldPower15 = _ShieldPatternPower;
			float4 Emission120 = ( ( ( Albedo279 * ShieldRimPower32 ) + lerpResult124 ) * ShieldPower15 );
...
/*ASEBEGIN
Version=17000
429;123;1152;808;1461.94;1910.33;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-3674.017,-1545.944;Float;False;Property;_ShieldAnimSpeed;Shield Anim Speed;18;0;Create;True;0;0;False;0;3;10;-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;136;-3624.635,276.1571;Float;False;Property;_HitPosition;Hit Position;23;0;Create;True;0;0;False;0;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;140;-3553.337,-269.7433;Float;False;Property;_HitSize;Hit Size;26;0;Create;True;0;0;False;0;0.2;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;276;-2780.04,-1808.4;Float;False;1504.24;684.7161;Comment;14;44;129;130;46;41;1;17;85;3;12;6;15;305;306;Shield Main Pattern;1,1,1,1;0;0
Node;AmplifyShaderEditor.ColorNode;138;-3595.025,-162.8425;Float;False;Property;_HitColor;Hit Color;25;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;3;-2716.901,-1757.5;Float;False;Property;_ShieldPatternColor;Shield Pattern Color;13;0;Create;True;0;0;False;0;0.2470588,0.7764706,0.9098039,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;129;-2730.04,-1558.843;Float;False;Property;_ShieldPatternSize;Shield Pattern Size;15;1;[IntRange];Create;True;0;0;False;0;5;3;1;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;137;-3157.953,205.9713;Float;False;Property;_HitTime;Hit Time;24;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;130;-2369.04,-1550.843;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;296;-1145.082,1049.553;Float;False;Mask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;41;-2209.397,-1408.801;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;306;-2099.523,-1205.022;Float;False;296;Mask;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;305;-1934.675,-1354.876;Float;False;2;2;0;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;86;-2670.01,-866.47;Float;True;Property;_ShieldPatternWaves;Shield Pattern Waves;19;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;206;-2903.502,-28.46932;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;269;-3643.936,791.2545;Float;False;1652.997;650.1895;Mix of Pattern, Wave, Rim , Impact and adding intersection highlight;20;125;210;262;5;122;113;124;127;126;120;114;110;96;95;270;20;301;302;303;304;Shield Mix for Emission;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-1761.211,-1434.652;Float;True;Property;_ShieldPattern;Shield Pattern;14;0;Create;True;0;0;False;0;None;f0ca3a19ebcb7d247a149b8c99501508;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;128;-1553.537,385.9566;Float;False;Property;_Color;Color;8;0;Create;True;0;0;False;0;0,0,0,0;0,0.6363635,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;275;-2010.258,-957.6005;Float;False;1030.896;385.0003;Comment;5;8;30;16;31;32;Shield RIM;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;17;-1451.905,-1424.215;Float;False;ShieldPattern;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;277;-1574.641,576.7259;Float;True;Property;_Albedo;Albedo;10;0;Create;True;0;0;False;0;None;a14e44ff271ceb346b7bb9cab66e24cc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-1956.507,-905.8556;Float;False;Property;_ShieldRimPower;Shield Rim Power;17;0;Create;True;0;0;False;0;7;0.21;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;114;-3430.724,1320.123;Float;False;Property;_IntersectIntensity;Intersect Intensity;21;0;Create;True;0;0;False;0;0.2;0.146;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-2023.2,-1712.1;Float;False;Property;_ShieldPatternPower;Shield Pattern Power;16;0;Create;True;0;0;False;0;5;5.6;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;113;-2798.831,1317.444;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;304;-2716.42,1058.071;Float;False;32;ShieldRimPower;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;122;-2961.037,841.2547;Float;False;Property;_IntersectColor;Intersect Color;22;0;Create;True;0;0;False;0;0.03137255,0.2588235,0.3176471,1;0.03137255,0.2588235,0.3176471,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;301;-2647.799,1192.848;Float;False;279;Albedo;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;124;-2651.837,931.354;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;102;-1432.937,42.85229;Float;False;Property;_ShieldDistortion;Shield Distortion;20;0;Create;True;0;0;False;0;0.01;0;0;0.03;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;303;-2453.576,1116.738;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;302;-2362.428,1009.326;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;127;-2466.838,1274.758;Float;False;15;ShieldPower;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;273;-1017.54,35.32507;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;66;-1129.406,-211.8437;Float;False;Simplex3D;False;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;126;-2200.239,1027.357;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;120;-2032.938,902.355;Float;False;Emission;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;280;-1148.441,-1639.674;Float;False;279;Albedo;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;30;-1673.799,-760.5671;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;10;False;3;FLOAT;10;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;290;-1102.446,-1754.094;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;23;-918.7656,-805.5688;Float;False;ShieldRim;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;297;-1017.903,-1327.156;Float;True;296;Mask;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;283;-822.6411,-1533.874;Float;False;282;Normal;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;286;-1243.983,-1220.729;Float;False;23;ShieldRim;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;295;-1867.082,1059.553;Float;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;121;-797.6182,-1439.73;Float;False;120;Emission;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;289;-1102.446,-1751.094;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-1248.615,-1445.004;Float;False;Property;_Opacity;Opacity;12;0;Create;True;0;0;False;0;0.2647059;0.31;-1000;1000;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;272;-790.1519,-1164.092;Float;False;271;VertexOffset;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;16;-1960.258,-774.4995;Float;False;32;ShieldRimPower;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ObjSpaceViewDirHlpNode;299;-1791.764,1285.272;Float;False;1;0;FLOAT4;0,0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FresnelNode;8;-1423.2,-799.8999;Float;True;Standard;TangentNormal;ViewDir;False;5;0;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;1;FLOAT;0.13;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;288;-1106.446,-1138.094;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;307;-826.9402,-1667.33;Float;False;Disintegration ShaderFunction;0;;1;906e3d1d685d8e34391e679db681ca66;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-551.0419,-1550.427;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;Custom/Tomas/EnergyScroll;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;1;False;-1;7;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;1;False;-1;1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=B67934246CEF5DD060E0C3369A12A4DBD6DA48A6